...
import { incoTerms } from '@/app/lib/incoterms';
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-semibold">Incoterm Information</h1>
                <div>
                {/* <button
                        ...
                        {incoTerms.map((incoterm, index) => (
                            <tr key={incoterm.id}>
                                <td>
                                    <input
                                        type="checkbox"
                                        onChange={e => handleSelectProduct(incoterm.id, e.target.checked)}
                                        checked={selectedProductIds.has(incoterm.id)}
                                    />
                                </td>
