...
import { Product, sampleIncoterms } from '@/app/lib/sampleIncoterms';
import Link from 'next/link';
import EditProductModal from './EditIncotermsModal';
import ViewProductModal from './ViewIncotermsModal';
import SearchInput from '@/app/ui/contracts/contract_drafting/incoterms/SearchInput';
import Pagination from '@/app/ui/contracts/products/Pagination';
import ExportButton from '@/app/ui/contracts/contract_drafting/incoterms/ExportButton';

export default function ProductRegisterPage() {
    const [products, setProducts] = useState<Product[]>(sampleIncoterms);
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-semibold">Incoterms Register</h1>
                <div>
                <button
      ...
      headers={[ 'name', 'productDescription']}
    />
                </div>
            </div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Are you sure you want to export the Incoterms to a CSV file?
                                            </p>
                                        </div>
                                    </div>
                                </div>
